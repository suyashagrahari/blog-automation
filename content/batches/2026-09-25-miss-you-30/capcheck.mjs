// Source-cap checker for batch 2026-09-25-miss-you-30.
...
const PRIOR = ["2026-08-12-miss-you-ldr"]
  .map((d) => `content/batches/${d}/blogs`);
const HERE = "content/batches/2026-09-25-miss-you-30/blogs";
...
const CFG = JSON.parse(fs.readFileSync("content/batches/2026-09-25-miss-you-30/verify.config.json", "utf8"));
