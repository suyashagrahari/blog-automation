# Wave 3 brief — 2026-08-27-birthday-30, the final 10
...
for p in glob.glob("content/batches/2026-08-27-birthday-30/blogs/*.json"):
...
node -e "
const fs=require('fs');
const j=JSON.parse(fs.readFileSync('content/batches/2026-08-27-birthday-30/blogs/<SLUG>.json','utf8'));
